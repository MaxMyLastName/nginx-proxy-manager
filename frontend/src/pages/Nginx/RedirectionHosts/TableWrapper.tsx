...
import { showDeleteConfirmModal, showHelpModal, showRedirectionHostLogsModal, showRedirectionHostModal } from "src/modals";
		...
		<div className="card mt-4">
			...
			<div className="card-table">
				...
				<Table
					...
					onViewLogs={(id, domainNames) => showRedirectionHostLogsModal(id, domainNames)}
					onDelete={(id: number) =>
