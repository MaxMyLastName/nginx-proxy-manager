...
import { showDeadHostLogsModal, showDeadHostModal, showDeleteConfirmModal, showHelpModal } from "src/modals";
		...
		<div className="card mt-4">
			...
			<div className="card-table">
				...
				<Table
					...
					onViewLogs={(id, domainNames) => showDeadHostLogsModal(id, domainNames)}
					onDelete={(id: number) =>
